        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                    <% for(Seller s : (List<Seller>) request.getAttribute("sellers")) {%>
                    ...
                    <tr>
                        ...
                        <td><%= s.getName()%></td>
                        <td><%= s.getEmail()%></td>
                        <td><%= s.getBirthDate().toString() %></td>
                        <td><%= s.getDepartment()%></td>
                        <td>R$:<%= s.getBaseSalary()%></td>
                        <td><a href="<%= request.getContextPath() %>/sellers/delete?id=<%= s.getId()%>" class="btn btn-sm btn-danger">Excluir</a></td>
                        <td><a href="/sellers/update?id=<%= s.getId()%>" class="btn btn-sm btn-primary">Editar</a></td>
                    </tr>
                    <% }%>
